...
3. Clone the Project
   ...
   - Via HTTPS: `git clone https://github.com/Cryptocurrency-TOOLS/OpenBBTerminal.git`
   - via SSH: `git clone git@github.com:Cryptocurrency-TOOLS/OpenBBTerminal.git`
...
<a href="https://github.com/Cryptocurrency-TOOLS/OpenBBTerminal/blob/master/TROUBLESHOOT.md">
...
Set the API keys [as explained here](https://github.com/Cryptocurrency-TOOLS/OpenBBTerminal/blob/main/DOCKER_ADVANCED.md#environment-variables).
...
terminal, see [this guide](https://github.com/Cryptocurrency-TOOLS/OpenBBTerminal/terminal/#accessing-other-sources-of-data-via-api-keys).
